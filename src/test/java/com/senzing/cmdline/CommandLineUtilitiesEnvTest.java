...
public class CommandLineUtilitiesEnvTest
{
     ...
     */
    @Test
    public void singleValueEnvVarPopulatesOption()
        throws Exception
    {
     ...
     */
    @Test
    public void synonymEnvVarPopulatesOption()
        throws Exception
    {
     ...
     */
    @Test
    public void booleanEnvVarEmptyStringMapsToTrue()
        throws Exception
    {
    ...
    @Test
    public void booleanEnvVarTrueMapsToTrue()
        throws Exception
    {
    ...
    @Test
    public void booleanEnvVarFalseMapsToFalse()
        throws Exception
    {
        new EnvironmentVariables(
     ...
     * / "false" must throw {@link IllegalArgumentException} per the documented
     * switch in {@code processEnvironment}.
     */
    @Test
    public void booleanEnvVarInvalidValueThrows()
        throws Exception
    {
        new EnvironmentVariables(
     ...
     */
    @Test
    public void multiValueEnvVarJsonArray()
        throws Exception
    {
        new EnvironmentVariables(
     ...
     */
    @Test
    public void multiValueEnvVarCommaSeparated()
        throws Exception
    {
        new EnvironmentVariables(
            "SENZING_ENV_TEST_TAGS", "red,green,blue").execute(() -> {
     ...
     */
    @Test
    public void multiValueEnvVarWhitespaceSeparated()
        throws Exception
    {
        new EnvironmentVariables(
            "SENZING_ENV_TEST_TAGS", "red green blue").execute(() -> {
    ...
    /**
     * Bounded multi-value option (min=2, max=3): supplying fewer than the
     * minimum via env var must throw {@link BadOptionParameterCountException}.
     */
    @Test
    public void multiValueEnvVarBelowMinThrows()
        throws Exception
    {
        new EnvironmentVariables(
     ...
     */
    @Test
    public void multiValueEnvVarAboveMaxThrows()
        throws Exception
    {
        new EnvironmentVariables(
     ...
     */
    @Test
    public void multiValueEnvVarInRange()
        throws Exception
    {
        new EnvironmentVariables(
    ...
    /**
     * If the option is also specified on the command line, the env-var value
     * must be ignored — explicit command-line wins.
     */
    @Test
     ...
     */
    @Test
    public void unsetEnvVarLeavesOptionAbsent()
        throws Exception
    {
