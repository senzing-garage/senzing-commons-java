...
public class JsonUtilitiesTest
{
    public List<Arguments> provideGetStringFromObjectParams()
    {
        ...
        String spouseText = toJsonText(jsonObj.getJsonObject("spouse"), true);
            ...
            Class expectedFailure)
    {
        try {
            ...
            if (expectedFailure != null) {
                fail("Expected a failure, but got success.  jsonObject=[ "
                     + jsonObject + " ], key=[ " + key + " ], result=[ "
            ...
            if (expectedFailure == null) {
                e.printStackTrace();
                fail("Unexpected failure.  jsonObject=[ " + jsonObject
                     + " ], key=[ " + key
                     + " ], result=[ " + expectedResult
                     + " ]: " + e);
            } else if (!expectedFailure.isAssignableFrom(e.getClass())) {
                e.printStackTrace();
                fail("Expected a different failure.  jsonObject=[ "
                     + jsonObject + " ], key=[ " + key
    ...
    public List<Arguments> provideGetStringFromArrayParams()
    {
        ...
        String spouseText = toJsonText(jsonArr.getJsonObject(5), true);
            ...
            Class expectedFailure)
    {
        try {
            ...
            if (expectedFailure != null) {
                fail("Expected a failure, but got success.  jsonArray=[ "
                     + jsonArray + " ], index=[ " + index + " ], result=[ "
                     + result + " ], expectedFailure=[ "
                     + expectedFailure.getName() + " ]");
            }
            ...
            if (expectedFailure == null) {
                e.printStackTrace();
                fail("Unexpected failure.  jsonArray=[ " + jsonArray
                     + " ], index=[ " + index
                     + " ], result=[ " + expectedResult
                     + " ]: " + e);
            } else if (!expectedFailure.isAssignableFrom(e.getClass())) {
    ...
    public List<Arguments> provideGetIntegerFromArrayParams()
    {
        ...
        builder.add(10);
        // 6
        builder.add(((long) Integer.MAX_VALUE) + 1L);
        // 7
        builder.add(10.0);
        // 8
        builder.add(10.5);
    ...
    public List<Arguments> provideGetDoubleFromObjectParams()
    {
        ...
        result.add(arguments(jsonObj, "long", null, ((double) maxIntPlus1),
                             null));
        result.add(arguments(jsonObj, "long", 15.0, ((double) maxIntPlus1),
                             null));
    ...
    public List<Arguments> provideGetFloatFromObjectParams()
    {
        ...
        result.add(arguments(jsonObj, "long", null, ((float) maxIntPlus1),
                             null));
        result.add(arguments(jsonObj, "long", 15.0F, ((float) maxIntPlus1),
                             null));
    ...
    public void addStringToObjectTest()
    {
        ...
        try {
            ...
            e.printStackTrace();
            fail(
                "Unexpected failure.  jsonObject=[ " + jsonObject + " ]: " + e);
        }
    }
    ...
    public List<Arguments> provideNormalizeJsonValueParams()
    {
        ...
        JsonNumber number = toJsonObject("value", 10).getJsonNumber("value");

        result.add(arguments(number, 10L));

        number = toJsonObject("value", 20.5).getJsonNumber("value");

        result.add(arguments(number, 20.5));

        JsonString string = toJsonObject("value", "Foo").getJsonString("value");
        ...
        if (value != null) {
            ...
            switch (value.getClass().getName())
            {
                ...
                case "java.lang.Boolean":
                    actual = (jsonValue.equals(JsonValue.TRUE))
                        ? true : (jsonValue.equals(JsonValue.FALSE))
                        ? false : jsonValue;
                    break;
                ...
                case "java.lang.Short":
                    actual = ((JsonNumber) jsonValue).numberValue()
                                                     .shortValue();
                    break;
    ...
    public void testToJsonObject2()
    {
        try {
            ...
            JsonObject actual = toJsonObject("foo", "bar", "phoo", true);
    ...
    public void testToJsonObject3()
    {
        try {
            ...
            JsonObject actual
                = toJsonObject("foo", "bar", "phoo", true, "num", 10L);
    ...
    public List<Arguments> provideToJsonObjectParams()
    {
        ...
        map1.put("object", Map.of("givenName", "Joe", "surname", "Schmoe"));
    ...
    public List<Arguments> provideToJsonTextParams()
    {
        ...
        String fullText = "{ " + "\"int\": 5, \"null\": null, " + "\"array\": "
            + arrText + ", " + "\"object\": " + objText + ", "
            + "\"text\": \"ABC\" }";
    ...
    public List<Arguments> provideIniToJsonParams()
    {
        ...
        JsonObject jsonObject = toJsonObject(Map.of("BASIC",
        ...
        jsonObject = toJsonObject(Map.of("BASIC", Map.of(
            "FOO",
            "BAR",
            "PHOO",
            "BAX",
    ...
    public List<Arguments> getJsonDateObjectParameters()
    {
        ...
        for (int index = 0; index < 10; index++) {
            ...
            // parse it back to account for precision loss due to JSON date
            // format
            instant = Instant.from(JsonUtilities.DATE_TIME_FORMATTER.parse(
                text));
            ...
            result.add(Arguments.of(createObject(key, text), key, instant,
                                    null));
        }
    ...
    @ParameterizedTest
    public void testGetInstantFromObject(
            JsonObject obj,
            String key,
            Instant expected,
            Class<? extends Throwable> exceptionType)
    {
        try {
            ...
            if (exceptionType != null) {
                fail("Succeeded on getInstant() for key (" + key
                     + ") when should have " + "failed: "
                                      ...
                                      Class<? extends Throwable> exceptionType)
    {
        try {
            ...
            if (exceptionType != null) {
                fail("Succeeded on getDate() for key (" + key
                     + ") when should have " + "failed: "
                     + JsonUtilities.toJsonText(obj));
            }
    ...
    public List<Arguments> getJsonDateArrayParameters()
    {
        ...
        result.add(Arguments.of(createArray(2, null), 2, null, null));
    ...
    @ParameterizedTest
    public void testGetInstantFromArray(
            JsonArray arr,
            int index,
            Instant expected,
            Class<? extends Throwable> exceptionType)
    {
        try {
            ...
            if (exceptionType != null) {
                fail("Succeeded on getInstant() for index (" + index
                     + ") when should have " + "failed: "
                                     ...
                                     Class<? extends Throwable> exceptionType)
    {
        try {
            ...
            if (exceptionType != null) {
                fail("Succeeded on getDate() for index (" + index
                     + ") when should have " + "failed: "
                     + JsonUtilities.toJsonText(arr));
            }
            Date expectedDate = (expected == null) ? null : Date.from(expected);
