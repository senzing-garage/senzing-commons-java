        ...
        try {
                 ...
                 FileOutputStream bomFOS = new FileOutputStream(bomFile))
            {
                ...
                if ((encoding.startsWith("UTF-16") || encoding.startsWith(
                    ...
                    OutputStreamWriter bomOSW
                        = new OutputStreamWriter(bomFOS, encoding);
                    bomOSW.write(0xFEFF);
                    bomOSW.write(text);
                    bomOSW.flush();
                } else {
            ...
            // do a sanity check that we have the byte-order-markers where
            // expected
            try (FileInputStream fis = new FileInputStream(file);
            ...
            try (FileInputStream fis = new FileInputStream(file);
                 ...
                 InputStreamReader bomISR
                     = new InputStreamReader(bomFIS, encoding))
            {
