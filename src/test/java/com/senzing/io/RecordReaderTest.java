...
public class RecordReaderTest
{
    ...
    public void setup()
    {
        ...
        this.jsonRecordsSansDS = JsonUtilities.toJsonText(recordArraySansDS,
                                                          true);
     ...
     */
    @Test
    public void jsonLinesSkipsCommentLines()
        throws IOException
    {
    ...
    /**
     * A JSON-Lines line with unparseable JSON must record the line number on
     * the {@link RecordReader} and rethrow the parse exception.
     */
    @Test
     ...
     */
    @Test
    public void constructorToleratesNullDataSourceMap()
        throws IOException
    {
        RecordReader reader = new RecordReader(
            RecordReader.Format.JSON_LINES,
     ...
     */
    @Test
    public void constructorNormalizesEmptySourceIdToNull()
        throws IOException
    {
        RecordReader reader = new RecordReader(
            new StringReader(
