...
public class PropertyReflector<T>
{
    ...
    public static synchronized <T>
        PropertyReflector<T> getInstance(Class<T> cls)
    {
     ...
     * <b>unmodifiable</b> {@link List} of mutator {@link Method} values for
        ...
        throws IllegalArgumentException
    {
        ...
        // if the property value is null then find the best method for setting
        // the
     ...
     *
     * @return <code>true</code> if the {@link Method} was found and invoked,
     *         and <code>false</code> if no {@link Method} was found to satisfy
     *         the {@link Predicate}.
     */
    ...
    /**
     * Uses reflection to extract the properties from the specified {@link
     * Object} and recursively construct a {@link JsonObject} from them and
     * return that {@link JsonObject}.
     *
     ...
     *                properties.
     * @param object The non-null {@link Object} whose properties should be
     *               added to the {@link JsonObjectBuilder}.
        ...
        throws NullPointerException
    {
        ...
        try {
            ...
            if (objectMap == null) {
                // if null then initialize the property reflector variables and
                // key set
            ...
            for (String propertyKey : keySet) {
                ...
                switch (propertyType.getName())
                {
                    case "javax.json.JsonObject":
                        ...
                        builder.add(propertyKey, Json.createObjectBuilder(
                            jsonObj));
                        break;

                    case "javax.json.JsonArray":
                        JsonArray jsonArr = (JsonArray) propertyValue;
                        builder.add(propertyKey, Json.createArrayBuilder(
                            jsonArr));
                        break;
                    ...
                    case "java.lang.Short":
                        builder.add(propertyKey,
                                    ((Number) propertyValue).intValue());
                        break;

                    case "java.lang.Long":
                        builder.add(propertyKey,
                                    ((Number) propertyValue).longValue());
                        break;
