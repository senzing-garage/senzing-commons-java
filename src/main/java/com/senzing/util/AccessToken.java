...
public final class AccessToken
{
     ...
     * from this method will be the same <b>until</b> the {@link AccessToken} is
     * claimed by {@link #claimThreadAccessToken()}.
     *
     * @return The current thread-local {@link AccessToken} for this thread
     *         which will change once {@link #claimThreadAccessToken()} is
     *         called.
     */
