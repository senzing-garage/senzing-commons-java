...
public class Timers {
    ...
    public static class TimedResult<T> {
        ...
        /**
         * The {@link Exception} associated with a failed operation.
         */
        private Exception failure;

        /**
         * Constructs with the specified data and {@link Timers}.
         * 
         * @param data The data obtained with the operation.
         * @param timers The {@link Timers} associated with the operation.
         */
        public TimedResult(T data, Timers timers) {
            this.data = data;
            this.timers = timers;
            this.failure = null;
        }
        ...
        /**
         * Gets the data obtained with the timed operation.
         * 
         * @return The data obtained with the timed operation.
         * 
         * @throws Exception If a failure occurred obtaining the data.
         */
        ...
        /**
         * Gets the {@linK Timers} associated with obtaining the data.
         * 
         * @return The {@link Timers} associated with obtaining the data.
         */
