...
public class ErrorLogSuppressor
{
    ...
    /**
     * The result of evaluating the current error for whether or not it should
     * be logged.
     */
    public static class Result
    {
         ...
         * last error.
         *
         * @return The {@link State} of the error suppressor after evaluating
         *         the last error.
         */
    ...
    /**
     * The threshold for the number of errors that can occur within the
     * specified window before triggering suppression.
     */
