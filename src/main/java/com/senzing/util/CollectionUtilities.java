...
public class CollectionUtilities
{
     ...
     * because the elements of a {@link Set} cannot be modified in place. </li>
        ...
        while (iter.hasNext()) {
            ...
            if (value != null) {
                if (value instanceof Set) {
                    entry.setValue(
                        (V) Collections.unmodifiableSet((Set) value));
                } else if (value instanceof List) {
                    entry.setValue((V) recursivelyUnmodifiableList(
                        (List) value));
    ...
    /**
     * Utility method for creating a <b>modifiable</b> {@link List} containing
    ...
    /**
     * Utility method for creating a <b>modifiable</b> {@link Set} containing
     * the specified elements.
     *
