...
public class Registry<T>
{
    ...
    /**
     * Constructs with the flag indicating if <code>null</code> references can
     * be bound in the registry.
     *
    ...
    /**
     * Checks whether this registry instance allows bindings to
     * <code>null</code> references. This returns <code>true</code> if
     * <code>null</code> bindings are allowed, otherwise <code>false</code> if
     * they are forbidden and would generate a {@link NullPointerException} on
     * an attempt to bind a <code>null</code> reference.
     *
     ...
     *
     * @param name The non-null name to which to bind the specified object
     *             should be bound.
     ...
     *                              or if <code>null</code> bindings {@linkplain
    ...
    /**
     * Looks up the object bound to the specified name and returns a reference
     * to it. If no object is bound to the specified name then a {@link
     ...
     * {@link Registry} instance to atomically combine a call to this method
     * with another method call on this instance.
     *
     ...
     * @param token The non-null {@link AccessToken} for authorizing permission
     *              to unbind the object.
     *
