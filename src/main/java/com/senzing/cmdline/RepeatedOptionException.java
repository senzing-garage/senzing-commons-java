...
public class RepeatedOptionException extends CommandLineException
{
     ...
     * that were used in case the same option can be specified with synonym
     * flags.
     *
     * @param option The {@link CommandLineOption} that was not repeated.
     * @param flags The {@link Set} of flags that were used to specify the
     *              option.
     */
    ...
    {
        StringBuilder sb
            = new StringBuilder("Option specified more than once: ");
