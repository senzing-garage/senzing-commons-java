...
public interface CommandLineParser
{
   ...
   *
   * @param deprecationWarnings The {@link List} to be populated with any {@link
   *                            DeprecatedOptionWarning} instances that are
   *                            generated, or <code>null</code> if the caller is
   *                            not interested in deprecation warnings.
   *
   * @return The {@link Map} of {@link CommandLineOption} keys to {@link Object}
   *             values describing the provided arguments.
   *
   * @throws CommandLineException If a command-line parsing/processing error
   *                              occurs.
   */
