...
public class CommandLineValue implements SpecifiedOption
{
    ...
    /**
     * Constructs with the specified option, {@link CommandLineSource},
     * processed value and {@link List} of {@link String} parameters that were
    ...
    /**
     * Gets the specifier associated with the {@link CommandLineSource} (if
     * any). This returns <code>null</code> if none.
     *
    ...
    /**
     * Sets the specifier associated with the {@link CommandLineSource} (if
     * any). Set this to <code>null</code> if none.
     *
     ...
     *
     * @return The processed value associated with the {@link
     *         CommandLineOption}.
     */
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equals(this.getOption(), value.getOption())
            && this.getSource() == value.getSource() && Objects.equals(
                this.getSpecifier(),
                value.getSpecifier()) && Objects.equals(
                this.getProcessedValue(),
                value.getProcessedValue()) && Objects.equals(
                this.getParameters(),
                value.getParameters());
    }
