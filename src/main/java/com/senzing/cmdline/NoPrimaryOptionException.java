...
public class NoPrimaryOptionException extends CommandLineException
{
     ...
     *                                  contains a {@link CommandLineOption}
    ...
    /**
     * Builds the error message describing the need to specify at least one of
     * the specified {@link Set} of options.
     *
     * @param primaryOptions The {@link Set} of {@link CommandLineOption}
     *                       instances identifying the primary options.
     *
    ...
    public static String buildErrorMessage(
            Set<CommandLineOption> primaryOptions)
