...
public class PoolConnectionProvider implements ConnectionProvider
{
    ...
    /**
     * Constructs with the specified {@link ConnectionPool} to back this
     * instance. The constructed instance will wait indefinitely for a {@link
     ...
     * time for waiting for a {@link Connection} from the pool. To specify that
     * no wait should be done, specify zero (0) as the wait time. To specify
     * that the provider should wait indefinitely then specify a negative
     * number.
     *
     * @param pool The {@link ConnectionPool} to use.
     * @param maxWait The maximum number of milliseconds to wait for a {@link
     *                Connection}, or zero (0) if no wait should be done, or a
     *                negative number to indicate an indefinite wait time.
     * @throws NullPointerException If the specified {@link ConnectionPool} is
     *                              <code>null</code>.
     */
    ...
    /**
     * Implemented to get the {@link Connection} within the optionally
     * configured maximum wait time. If a {@link Connection} cannot be obtained
     ...
     *
     * @return The maximum number of milliseconds to wait for a {@link
