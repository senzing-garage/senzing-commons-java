...
public enum DatabaseType
{
            ...
            case SQLITE:
                {
                    ...
                    ps.setString(index, DATE_TIME_FORMATTER.format(
                        zonedDateTime));
                }
                break;
            default:
            ...
            case SQLITE:
                {
                    ...
                    cs.setString(index, DATE_TIME_FORMATTER.format(
                        zonedDateTime));
                }
                break;
            default:
    ...
    /**
     * Provides a generic way to format the equivalent of the SQL "least"
     ...
     *              variable length parameters.
     * @return The formatted SQL "greatest" function for the respective
     *         database.
     * @throws NullPointerException If either the first or second parameters is
     *                              <code>null</code>.
     */
