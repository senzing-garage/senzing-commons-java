...
{
    /**
     * A simple global registry for non-null {@link ConnectionProvider}
     * instances. This acts as a simplified version of {@link
     * javax.naming.Context} that is dedicated to instances of {@link
     * ConnectionProvider} and confined to an in-memory naming registry.
     *
     * @see Registry
     */
     ...
     * @throws SQLException If the {@link Connection} could not be obtained due
     *                      to some failure.
     */
